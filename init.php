...
$scheduler = new \Emphloyer\Scheduler(new \Emphloyer\Pdo\SchedulerBackend($dsn, $user, $password, array(), "test_scheduled_jobs"));
$scheduler->schedule($job);

$pipeline = new \Emphloyer\Pipeline(new \Emphloyer\Pdo\PipelineBackend($dsn, $user, $password, array(), "test_jobs"));
